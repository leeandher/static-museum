...
`;
  ...
  console.log(plaqueLinks.childElementCount);
...
const PLAQUE_DATA = {
  ...
  tribute: {
    ...
    date: "2018",
    description:
      "So the assignment was to make a tribute page, but I had a color scheme in mind and so I picked some characters from Hotline Miami. Re-evaluating that decision today, I can see how having a tribute page to violent, creepy characters might make me look, but the CSS is still sweet.",
    backLink: "https://v0.leander.xyz/#portfolio",
  },
  v1: {
    title: "It's (a)LIVE",
  ...
  wikiview: {
    ...
    date: "2018",
    description:
      "I'm still impressed with the level of free access to the Wikipedia API. It's been ages and this thing still works as I built it, which means all kinds of bugs I never noticed back then. Regardless, I do remember feeling very proud of the UI and animation, it's still pretty clean.",
  ...
  "catch-of-the-day": {
    ...
    date: "2018",
    description:
      "From my first course (and time) using React, in all it's class-based component, lifecycle method glory. Most of what this site uses would be considered crimes against React these days, but it's still a perfectly functional weird fish market.",
  ...
  bgcg: {
    ...
    backLink: "https://v2.leander.xyz/projects/best-grilled-cheese-generator/",
  },
  conway: {
  ...
  delicious: {
    ...
    date: "2018",
    description:
      "From a NodeJS course way back when. I'm into the look of a bright gradient over the banner photos, and the colours of the whole thing still pop. I also adore the idea of small purpose built sites, and even though this one is artificial, the idea of building a personal review store is kinda cute. Name is pretty bad though.",
  ...
  reduxstagram: {
    ...
    date: "2018",
    description:
      "This site is from a course originally sponsored by <i>Sentry</i> long before I ever worked there. It was one of the first times I'd heard of it, and seeing a familiar name in job listings definitely played a role in my applying. Also, remember when instagram actually did look like this?",
  ...
  "stacker-news": {
    ...
    date: "2019",
    description:
      "Kinda feels like cosplaying since I've never been someone who reads <i>HackerNews</i> (and probably never will). GraphQL was hot at the time, and the tutorial I followed built this clone as a demo of the tool. I still think it's crazy that it's near identical to the real one with like 8 lines of CSS.",
  ...
  "md-prevuer": {
    ...
    date: "2019",
    description:
      "The first project I ever built with Vue. Never really went too deep on it, but I didn't want React to be the only framework I'd seen. It's just simple app, but probably one of my most directly useful.",
  ...
  "space-shooter": {
    ...
    date: "2018",
    description:
      "I took an interest to <i>Unity</i> at one point, and was pretty surprised when I found out you can build it for web. Game development has always been something I mean to get around too, and I do remember enjoying this tutorial project. Feels like a huge overlap in my hobbies and interests, but fairly daunting as well.",
